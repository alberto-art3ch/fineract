...
@Path("/v1/payments")
@Component
@Tag(name = "CallbacksForPayments")
@RequiredArgsConstructor
@ConditionalOnProperty("fineract.mpesa.enabled")
public class MPesaApiResource implements MPesaApi {

    private final MPesaApiDelegate delegate;
    ...
    @Operation(summary = "Callback for Payment Confirmation")
    public ConfirmationPaymentData paymentConfirmation(ConfirmationPaymentRequest request) {
        return delegate.paymentConfirmation(request);
    }
